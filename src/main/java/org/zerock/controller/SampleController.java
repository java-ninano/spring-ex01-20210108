...
public class SampleController {
	...
	@RequestMapping("") // 실제 일은 method가 하니깐
	public void basic() {
		log.info("basic.............");
	...
	public void basixGet2() {
		log.info("basic get only get...................");
	}

	@GetMapping("/ex02") // get 방식으로만
	...
	// 134쪽
		...
		public void initBinder(WebDataBinder binder) {
			...
			binder.registerCustomEditor(java.util.Date.class, new CustomDataEditor(dataFormat,false)); 
