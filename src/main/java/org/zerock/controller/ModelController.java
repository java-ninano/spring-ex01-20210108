...
//		request.setAttribute("abc", abc);
	...
	public void method2(@ModelAttribute("name") String name) {
		// public void method2(@ModelAttribute("name") String name, Model model) {
		log.info("method2");
	...
	@RequestMapping("/ex4")
	public void mehtod4(@ModelAttribute ("member")Member member ) {
	...
	public void mehtod5(@ModelAttribute Member member ) {
